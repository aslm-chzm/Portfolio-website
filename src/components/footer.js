    ...
    <div className="flex flex-row-ns flex-column pv6 f7 w-100 gray justify-between layoutMaxWidth center">
        ...
        <div className="mv4 mv0-ns">
            <a
                ...
                href="https://www.linkedin.com/in/aslm-chzm/">
            ...
            <a
                className={footerIconsClasses}
                href="mailto:heinselm@icloud.com
                ">
            ...
            <a
                className={footerIconsClasses}
                href="https://github.com/aslm-chzm/">
                <svg width='16' height='16' xmlns='http://www.w3.org/2000/svg' fill='currentColor'
            ...
            <a
                className={footerIconsClasses}
                href="https://www.instagram.com/anselm_chilz/">
                <svg width='16' height='16' xmlns='http://www.w3.org/2000/svg' fill='currentColor'
                    viewBox='0 0 512 512'>
            ...
            <a
                className={footerIconsClasses}
                href="https://twitter.com/anselm_chilz">
                <svg width='16' height='16' xmlns='http://www.w3.org/2000/svg' fill='currentColor'
                    viewBox='0 0 612 612'>
